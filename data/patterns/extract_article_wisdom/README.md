...
<h4><code>extractwisdom</code> is a <a href="https://github.com/creativerezz/aio" target="_blank">Fabric</a> pattern that <em>extracts wisdom</em> from any text.</h4>
...
```sh
curl -sS https://raw.githubusercontent.com/creativerezz/aio/main/patterns/extract_wisdom/dmiessler/extract_wisdom-1.0.0/system.md
```

### Pull the _user_ prompt directly

```sh
curl -sS https://raw.githubusercontent.com/creativerezz/aio/main/patterns/extract_wisdom/dmiessler/extract_wisdom-1.0.0/user.md
```
