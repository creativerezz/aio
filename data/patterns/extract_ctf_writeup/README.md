...
<h4><code>extract_ctf_writeup</code> is a <a href="https://github.com/creativerezz/aio" target="_blank">Fabric</a> pattern that <em>extracts a short writeup</em> from a warstory-like text about a cyber security engagement.</h4>
