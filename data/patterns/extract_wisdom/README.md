...
```sh
curl -sS https://github.com/creativerezz/aio/blob/main/extract-wisdom/dmiessler/extract-wisdom-1.0.0/system.md
```

### Pull the _user_ prompt directly

```sh
curl -sS https://github.com/creativerezz/aio/blob/main/extract-wisdom/dmiessler/extract-wisdom-1.0.0/user.md
```
