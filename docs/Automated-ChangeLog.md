...
```markdown
### PR [#1672](https://github.com/creativerezz/aio/pull/1672) by [ksylvan](https://github.com/ksylvan): Changelog Generator Enhancement
...
### PR [#1671](https://github.com/creativerezz/aio/pull/1671) by [contributor](https://github.com/contributor): Bug Fix
