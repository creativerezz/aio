...
Add notification settings to your `~/.config/aio/config.yaml`:
...
fabric --config ~/.config/aio/work-config.yaml --notification

# Personal computer (with sound)
fabric --config ~/.config/aio/personal-config.yaml --notification
```
