...
```bash
grep GITHUB_API_KEY ~/.config/aio/.env
```
...
AIO_MODEL_analyze_claims=GitHub|openai/gpt-4.1
AIO_MODEL_extract_wisdom=GitHub|openai/gpt-4.1

# Use GPT-4o-mini for simple tasks
AIO_MODEL_summarize=GitHub|openai/gpt-4o-mini
AIO_MODEL_extract_article_wisdom=GitHub|openai/gpt-4o-mini

# Use Llama for code tasks
AIO_MODEL_explain_code=GitHub|meta/llama-3.1-70b
```
...
echo "$(date): Used gpt-4.1 for analyze_claims" >> ~/.config/aio/usage.log

# Check daily usage
grep "$(date +%Y-%m-%d)" ~/.config/aio/usage.log | wc -l
```
...
# Switch profiles
ln -sf ~/.config/aio/.env.dev ~/.config/aio/.env
```
...
- [Fabric GitHub Repository](https://github.com/creativerezz/aio)
- [Fabric Issues](https://github.com/creativerezz/aio/issues)
- [Fabric Discussions](https://github.com/creativerezz/aio/discussions)
