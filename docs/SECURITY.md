...
Send security reports directly to the project maintainer via GitHub Issues (private vulnerability reporting).
...
*We take security seriously and appreciate the security research community's help in keeping Aio secure.*
