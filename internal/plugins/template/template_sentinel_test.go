	...
	withTestExtension(t, "echo-test", scriptContent, func(mgr *ExtensionManager, name string) {
		...
		tests := []struct {
		...
		}{
			{
				...
				template:       "{{ext:echo-test:echo:__AIO_INPUT_SENTINEL_TOKEN__}}",
				input:          "test input data",
				wantContain:    "RECEIVED: test input data",
				wantNotContain: "__AIO_INPUT_SENTINEL_TOKEN__",
			},
			{
			...
			},
			{
				...
				template:       "Result: {{ext:echo-test:echo:__AIO_INPUT_SENTINEL_TOKEN__}}",
				input:          "What is AI?",
...
`
	...
	withTestExtension(t, "arg-test", scriptContent, func(mgr *ExtensionManager, name string) {
		...
		template := "{{ext:arg-test:echo:prefix-__AIO_INPUT_SENTINEL_TOKEN__-suffix}}"
		input := "MYINPUT"
		...
		if strings.Contains(got, "__AIO_INPUT_SENTINEL_TOKEN__") {
