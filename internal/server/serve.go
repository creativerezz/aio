...
import (
	...
	_ "github.com/creativerezz/aio/docs" // swagger docs
)

// @title Aio REST API
// @version 1.0
// @description REST API for Aio AI augmentation framework. Provides endpoints for chat completions, pattern management, contexts, sessions, and more.
// @contact.name Aio Support
// @contact.url https://github.com/creativerezz/aio
// @license.name MIT
