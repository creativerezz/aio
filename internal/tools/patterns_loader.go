...
import (
	...
	"github.com/creativerezz/aio/internal/tools/githelper"

	"github.com/otiai10/copy"
)

const DefaultPatternsGitRepoUrl = "https://github.com/creativerezz/aio.git"
...
func (o *PatternsLoader) configure() (err error) {
	...
	tempDir, err := os.MkdirTemp("", "aio-patterns-")
	if err != nil {
