...
```bash
curl -fsSL https://raw.githubusercontent.com/creativerezz/aio/main/scripts/installer/install.sh | INSTALL_DIR=/usr/local/bin bash
```

For system-wide installation (requires sudo):

```bash
curl -fsSL https://raw.githubusercontent.com/creativerezz/aio/main/scripts/installer/install.sh | sudo INSTALL_DIR=/usr/local/bin bash
```
...
```powershell
$env:INSTALL_DIR="C:\tools"; iwr -useb https://raw.githubusercontent.com/creativerezz/aio/main/scripts/installer/install.ps1 | iex
```
