...
- Formats output to match README style:
  - [vX.Y.Z](https://github.com/creativerezz/aio/releases/tag/vX.Y.Z) (Aug 14, 2025) — **Feature Name**: Short description
...
def build_item(
    ...
    url = f"https://github.com/creativerezz/aio/releases/tag/{version}"
