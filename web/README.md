...
A user-friendly web interface for [Fabric](https://github.com/creativerezz/aio) built with [Svelte](https://svelte.dev/), [Skeleton UI](https://www.skeleton.dev/), and [Mdsvex](https://mdsvex.pngwn.io/).

![Aio Web App Preview](../docs/images/svelte-preview.png)
*Alt: Screenshot of the Aio web app dashboard showing pattern inputs and outputs.*

## Table of Contents

- [Aio Web App](#aio-web-app)
...
> [!NOTE]
> Requires Node.js ≥18 and Fabric installed globally (`aio --version` to check).

From the Aio root directory:
...
Turn `web/src/lib/content/` into an [Obsidian](https://obsidian.md) vault for note-taking synced with Aio patterns. It includes pre-configured `.obsidian/` and `templates/` folders.
...
3. Use Aio patterns to generate content directly in Markdown files.
