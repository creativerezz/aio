...
If Aio is already installed and you see aio/web, go to step 3

If aio is not installed, ensure Go is installed https://go.dev/doc/install and node / npm for web https://nodejs.org/en/download.

There are many ways to install aio. Here's one approach that usually works well:

## Step 1: clone the repo
In terminal, from the parent directory where you want to install aio:
git clone https://github.com/creativerezz/aio.git
...
# Add aio to PATH
export PATH="/Users/USERNAME/Documents/aio:$PATH"

# Define the base directory for Obsidian notes
obsidian_base="/Users/USERNAME/Documents/aio/web/myfiles/Aio_obsidian"

# Define the patterns directory
patterns_dir="/Users/USERNAME/Documents/aio/patterns"
...
Terminal 1: Start the Aio API Server
aio --serve
...
Start Script 
1. Create a new file named start-aio.command on your Desktop:

#!/bin/bash

# Change to the fabric web directory
cd "$HOME/Documents/Github/aio/web"

# Start fabric serve in the background
osascript -e 'tell application "Terminal" to do script "cd '$HOME'/Documents/Github/aio/web && aio --serve; exit"'

# Wait a moment to ensure the aio server starts
sleep 2

# Start npm development server in a new terminal
osascript -e 'tell application "Terminal" to do script "cd '$HOME'/Documents/Github/aio/web && npm run dev; exit"'

# Close this script's terminal window after starting servers
echo "Aio servers started!"
sleep 1
...
2. Create a new file named stop-aio.command on your Desktop:
...
chmod +x ~/Desktop/start-aio.command
chmod +x ~/Desktop/stop-aio.command
