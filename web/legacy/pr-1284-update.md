...
### 5. Strategy flags
- strategies are fetch from .config/aio/strategies for server processing
...
1. `~/.config/aio/patterns/` directory: The source of truth for available patterns
...
- Add patterns to `~/.config/aio/patterns/`
